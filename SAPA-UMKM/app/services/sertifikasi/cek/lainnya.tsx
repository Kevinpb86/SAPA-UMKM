          ...
          >
            ...
            >
              ...
              <Animated.View style={[styles.floatingIcon, { top: '15%', right: '10%', transform: [{ translateY: floatY }] }]}>
                <Feather name="file-text" size={80} color="#FFFFFF" style={{ opacity: 0.05 }} />
              </Animated.View>

              <View style={styles.heroContent}>
                <Text style={styles.heroKicker}>Sertifikasi</Text>
                <Text style={styles.heroTitle}>Standar Khusus</Text>
                <Text style={styles.heroSubtitle}>
                  Validasi sertifikasi internasional atau standar khusus lainnya (ISO, HACCP, Organik, dll).
                </Text>
              </View>
            </LinearGradient>
          </Animated.View>
          ...
          <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
            <View style={styles.header}>
              ...
              <View style={styles.headerCopy}>
                <Text style={[styles.title, { color: colors.text }]}>Data Sertifikasi</Text>
                <Text style={[styles.subtitle, { color: colors.subtle }]}>
                  Lengkapi detail sertifikasi khusus yang ingin Anda periksa keabsahannya.
                </Text>
              </View>
            </View>
