          ...
          >
            ...
            >
              ...
              <View style={styles.heroContent}>
                ...
                <Text style={styles.heroTitle}>Cek Sertifikat SNI</Text>
                <Text style={styles.heroSubtitle}>
                  Validasi standar mutu nasional produk Anda agar sesuai dengan regulasi Indonesia.
                </Text>
              </View>
            </LinearGradient>
          </Animated.View>
            ...
            <View style={styles.header}>
              ...
              <View style={styles.headerCopy}>
                ...
                <Text style={[styles.subtitle, { color: colors.subtle }]}>
                  Masukkan detail sertifikat SNI yang tercantum pada dokumen legal Anda.
                </Text>
              </View>
            </View>
